      ...
      <Section>
        <div className={`${styles.footerContainer} flex`}>
          <div className="flex flex-1">
            ...
            />
            <div
              className={`flex flex-col justify-around ${styles.description}`}
            >
              ...
              <div className="flex items-center">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clipPath="url(#clip0_39_14)">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M45 0H0V44H45V0ZM33.8369 18.01L22.8349 7.00985C21.8213 5.99639 20.1785 5.99725 19.1641 7.00924L19.1634 7.00988L4.46968 21.7028C4.17678 21.9957 4.17677 22.4706 4.46966 22.7635C4.76254 23.0564 5.23742 23.0564 5.53032 22.7635L7.94231 20.3517V35.1542C7.94231 36.5874 9.10529 37.75 10.5385 37.75H14.8462H17.3077H24.6923H28.3846H31.4615C32.8947 37.75 34.0577 36.5874 34.0577 35.1542V20.3519L36.4697 22.7636C36.7626 23.0564 37.2375 23.0564 37.5304 22.7635C37.8232 22.4706 37.8232 21.9957 37.5303 21.7028L33.8391 18.0122L33.8369 18.01ZM23.9423 36.25H18.0577V29.0013C18.0577 28.3967 18.5489 27.9055 19.1538 27.9055H22.8462C23.4511 27.9055 23.9423 28.3967 23.9423 29.0013V36.25Z"
                        fill="white"
                      />
                    </g>
                    <defs>
